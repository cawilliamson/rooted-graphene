...
KERNEL_BUILD_COMMAND="pushd aosp/; tools/bazel run --config=fast //common:kernel_aarch64_dist -- --dist_dir=dist; popd; ./build_comet.sh --config=no_download_gki --config=no_download_gki_fips140 --lto=full"
